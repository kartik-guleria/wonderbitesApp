...
const Q8 = props => {
  ...
  const ACTIVENESS = [
    {id: 1, title: t('mealPlan:vegetarian'), subTitle:t('mealPlan:noMeat')},
    {id: 2, title: t('mealPlan:omni'), subTitle: t('mealPlan:meatVegetables')},
    ];
